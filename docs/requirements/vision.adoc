...
Ludwig Schönthier <ludwig.schoenthier@htw-dresden.de>;
18.11.2021
...
|Barbetreiber |Besitzer der Cocktailbar |
|Versanddienstleister |versendet Cocktails an Kunden |
|Webhoster |Webseite sowie Datenbank |
|Kunde |benutzt Dienstleister mobil und von zuhause |muss gut geleitet werden
|Benutzerumgebung |Bestellmengen |
|Bezahldienstleister |Geldtransfer
|Gesetzgeber | |
|===
